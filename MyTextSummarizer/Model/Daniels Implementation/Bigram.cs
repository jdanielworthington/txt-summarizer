...
namespace MyTextSummarizer.Model.Daniels_Implementation
{
    /// <summary>
    /// Created by J. Daniel Worthington
    /// Data structure that maintains a Bigram structure in which the frequency of
    /// pairs of words are stored in a Dictionary
    /// </summary>
    public class Bigram
    {
